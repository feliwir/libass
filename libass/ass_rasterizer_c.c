                               ...
                               int winding)
{
    ...
    for (; line != end; ++line) {
        ...
        if (!line->x_min && (line->flags & SEGFLAG_EXACT_LEFT))
            dn_delta ^= 4;
        ...
        int16_t a =
            (line->a * (int64_t) line->scale + ((int64_t) 1 << 49)) >> 50;
        int16_t b =
            (line->b * (int64_t) line->scale + ((int64_t) 1 << 49)) >> 50;
        int16_t c =
            ((int32_t) (line->c >> 11) * (int64_t) line->scale +
             ((int64_t) 1 << 44)) >> 45;
        c -= (a >> 1) + b * up;
        ...
        if (up_pos) {
            if (dn == up) {
                update_border_line16(res[up], abs_a, va, b, abs_b, c,
                                     up_pos, dn_pos);
                continue;
            }
            update_border_line16(res[up], abs_a, va, b, abs_b, c, up_pos,
                                 64);
            up++;
            c -= b;
        }
        ...
        if (dn_pos)
            update_border_line16(res[dn], abs_a, va, b, abs_b, c, 0,
                                 dn_pos);
    }
                               ...
                               int winding)
{
    ...
    for (; line != end; ++line) {
        ...
        int16_t a =
            (line->a * (int64_t) line->scale + ((int64_t) 1 << 50)) >> 51;
        int16_t b =
            (line->b * (int64_t) line->scale + ((int64_t) 1 << 50)) >> 51;
        int16_t c =
            ((int32_t) (line->c >> 12) * (int64_t) line->scale +
             ((int64_t) 1 << 44)) >> 45;
        c -= (a >> 1) + b * up;
        ...
        if (up_pos) {
            if (dn == up) {
                update_border_line32(res[up], abs_a, va, b, abs_b, c,
                                     up_pos, dn_pos);
                continue;
            }
            update_border_line32(res[up], abs_a, va, b, abs_b, c, up_pos,
                                 64);
            up++;
            c -= b;
        }
        ...
        if (dn_pos)
            update_border_line32(res[dn], abs_a, va, b, abs_b, c, 0,
                                 dn_pos);
    }
